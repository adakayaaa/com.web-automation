...
public class Droppable_RevertDraggablePosition_Test extends Hooks {
    ...
    void testRevertDraggablePosition() throws InterruptedException {
        ...
        int initialXForFirstElement = pages.getDroppableRevertDraggablePositionPage().getLocationOfDraggableX(pages.getDroppableRevertDraggablePositionPage().getFirstElement());
        int initialYForFirstElement = pages.getDroppableRevertDraggablePositionPage().getLocationOfDraggableY(pages.getDroppableRevertDraggablePositionPage().getFirstElement());

        //4. Drag the first draggable element and drop it to the target-droppable element
        pages.getDroppableRevertDraggablePositionPage().dragAndDrop(pages.getDroppableRevertDraggablePositionPage().getFirstElement());

        // 5. Verify that the first draggable element has  been dropped to the target-droppable element
        Assertions.assertThat(pages.getDroppableRevertDraggablePositionPage().getDroppableElementText()).isEqualTo("Dropped!");

        Thread.sleep(3000);
        // get the final location of the first element
        int finalXForFirstElement= pages.getDroppableRevertDraggablePositionPage().getLocationOfDraggableX(pages.getDroppableRevertDraggablePositionPage().getFirstElement());
        int finalYForFirstElement= pages.getDroppableRevertDraggablePositionPage().getLocationOfDraggableY(pages.getDroppableRevertDraggablePositionPage().getFirstElement());
       ...
       softAssertions.assertThat(finalYForFirstElement-initialYForFirstElement).isEqualTo(0);
        ...
        //7. Drag the second draggable element and drop it to the target-droppable element
        pages.getDroppableRevertDraggablePositionPage().dragAndDrop(pages.getDroppableRevertDraggablePositionPage().getSecondElement());

        // 8. Verify that the second draggable element has been dropped to the target-droppable element
             //find the second element edges
        int secondDraggableElementTopEdge = pages.getDroppableRevertDraggablePositionPage().getDraggableElementTopEdge(pages.getDroppableRevertDraggablePositionPage().getSecondElement());
        int secondDraggableElementBottomEdge = pages.getDroppableRevertDraggablePositionPage().getDraggableElementBottomEdge(pages.getDroppableRevertDraggablePositionPage().getSecondElement());
        int secondDraggableElementRightEdge = pages.getDroppableRevertDraggablePositionPage().getDraggableElementRightEdge(pages.getDroppableRevertDraggablePositionPage().getSecondElement());
        int secondDraggableElementLeftEdge = pages.getDroppableRevertDraggablePositionPage().getDraggableElementLeftEdge(pages.getDroppableRevertDraggablePositionPage().getSecondElement());
        ...
        int droppableElementBottomEdge =pages.getDroppableRevertDraggablePositionPage().getDroppableElementBottomEdge();
