...
public class Selectable_Seriliaze_Test extends Hooks {
    ...
    void testSelectableSeriliaze() {
        ...
        // 5. Verify that Item 5 is selected
        Assertions.assertTrue(pages.getSelectableSeriliazePage().isTheItemSelectedByIndex(5),"The item is not selected!");

        // 6. Verify that "You've selected: #5" is displayed
        Assertions.assertTrue(pages.getSelectableSeriliazePage().isTheFeedBackAreaDisplayed(),"The feedback is not displayed!");
        ...
        // 8. Verify that Item 6 is selected
        Assertions.assertTrue(pages.getSelectableSeriliazePage().isTheItemSelectedByIndex(6),"The item is not selected!");
        ...
        // 11. Verify that Item 1, Item 3 are selected
        Assertions.assertTrue(pages.getSelectableSeriliazePage().isTheItemSelectedByIndex(1)
                && pages.getSelectableSeriliazePage().isTheItemSelectedByIndex(3),"The items are not selected");
